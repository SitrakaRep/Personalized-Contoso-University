...
namespace ContosoUniversity.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            int pageSize = 2;
            // return Ok(new {result = await PaginatedList<Student>.CreateAsync(students.AsNoTracking(), page ?? 1, pageSize)});
            return View(await PaginatedList<Student, StudentsViewModel>.CreateAsync(students.AsNoTracking(), page ?? 1, pageSize));
        }
